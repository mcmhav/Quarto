...
public class Game {
    ...
    public void setPlayer1(NooBPlayer player1) {
    ...
    public void setPlayer2(NooBPlayer player2) {
    ...
    public void setActivePlayer(NooBPlayer activePlayer) {
    ...
    public void playTurn(boolean log, Scanner scanner, boolean doMiniMax){
        ...
        if(log){
            System.out.println("layer #"+this.activePlayer.getPlayerID()+"'s turn to place piece "+piece.toString());
        }
    ...
    public void initGame(Scanner scanner){
        ...
        while(scanner.hasNext() && again){
            ...
            if(settings.length == 1){
                ...
                switch(settings[0].toUpperCase().charAt(0)){
                    case 'H':
                        this.setPlayer1(new NooBPlayer(PlayerType.HUMAN, 1));
                        break;
                    case 'R':
                        this.setPlayer1(new NooBPlayer(PlayerType.RANDOM, 1));
                        break;
                    case 'N':
                        this.setPlayer1(new NooBPlayer(PlayerType.NOVICE, 1));
                        break;
                    default:
                        if(settings[0].toUpperCase().startsWith("M")){
                            String[] depth = settings[0].split("");
                            if(depth[2].matches("\\d")){
                                this.setPlayer1(new NooBPlayer(PlayerType.MINIMAXD, 1, Integer.parseInt(depth[2])));
                                break;
                            }
                        }
                ...
                switch(settings[1].toUpperCase().charAt(0)){
                    case 'H':
                        this.setPlayer2(new NooBPlayer(PlayerType.HUMAN, 2));
                        break;
                    case 'R':
                        this.setPlayer2(new NooBPlayer(PlayerType.RANDOM, 2));
                        break;
                    case 'N':
                        this.setPlayer2(new NooBPlayer(PlayerType.NOVICE, 2));
                        break;
                    default:
                        if(settings[1].toUpperCase().startsWith("M")){
                            String[] depth = settings[1].split("");
                            if(depth[2].matches("\\d")){
                                this.setPlayer2(new NooBPlayer(PlayerType.MINIMAXD, 2, Integer.parseInt(depth[2])));
                                break;
                            }
                        }
